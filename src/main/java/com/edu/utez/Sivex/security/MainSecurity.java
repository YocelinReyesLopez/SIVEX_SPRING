package com.edu.utez.Sivex.security;

import com.edu.utez.Sivex.security.jwt.JwtAuthenticationFilter;
        ...
        http.cors(Customizer.withDefaults()).csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(req ->
                        req.requestMatchers(WHITE_LIST).permitAll()
                                ...
                                .requestMatchers("/api/Sivex/usuario/**").hasAnyAuthority("ADMIN_ROLE", "USER_ROLE")
